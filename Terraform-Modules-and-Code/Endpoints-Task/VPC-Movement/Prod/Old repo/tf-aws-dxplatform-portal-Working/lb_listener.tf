...
#******************************#
#Creating the Listuner for New Prod Target Group
#******************************#
...
resource "aws_lb_listener" "prod_alb_listener" {
  ...
  default_action {
    order            = "2"
    #target_group_arn = "arn:aws:elasticloadbalancing:ap-southeast-1:768502287836:targetgroup/PocDxinfraportal-TG/8b2017faf2b0985d" #Old ARN
    target_group_arn = "arn:aws:elasticloadbalancing:ap-southeast-1:768502287836:targetgroup/PocDxinfraportal-TG-Prod/325740426d5e9493" #NEW ARN
    type             = "forward"
  }

  #load_balancer_arn = data.terraform_remote_state.alb.outputs.aws_lb_tfer--PocDxinfraportal-Prod_id  #Commenting ole data LB ARN Name
  load_balancer_arn = aws_lb.tfer--PocDxinfraportal-Prod.arn #New LB ARN Name
  port              = "443"
  protocol          = "HTTPS"
  ssl_policy        = "ELBSecurityPolicy-TLS-1-2-2017-01"
  tags = {
