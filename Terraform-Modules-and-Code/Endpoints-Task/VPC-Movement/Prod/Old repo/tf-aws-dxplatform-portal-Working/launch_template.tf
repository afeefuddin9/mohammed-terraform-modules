resource "aws_launch_template" "tfer--DXPFPlatformPortal-20210518080118621000000002" {
  ...
  network_interfaces {
    ...
    #security_groups            = ["sg-0d2aebd6362d7d24f"] #Commenting old SG
    security_groups             = ["sg-06055e2cff62e28e8"] #Adding New SG
  }
...
resource "aws_launch_template" "tfer--DXPlatformPortal-Prod" {
  ...
  #vpc_security_group_ids = ["sg-0d2aebd6362d7d24f"] #Commenting old SG
  vpc_security_group_ids = ["sg-06055e2cff62e28e8"] #Adding new SG
}
...
resource "aws_launch_template" "tfer--DXPlatformPortal-Staging" {
  ...
  #image_id      = "ami-083fa692c03b5b587" #old AMI
  image_id = "ami-0f54f3f72bb55fb2e" #New AMI
  instance_type = "t2.micro"
  key_name      = "DXInfra"
